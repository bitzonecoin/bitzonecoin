Contributing to BITZONECOIN Core
============================

The BITZONECOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BITZONECOIN Core project, and is not to be
confused with overall BITZONECOIN Network Protocol consensus changes.

Whether a pull request is merged into BITZONECOIN Core rests with the project merge
...
Patches that change BITZONECOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the BITZONECOIN consensus, it must have been
...
The project leader is the release manager for each BITZONECOIN Core release.
