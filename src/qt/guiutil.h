...
/** Utility functions used by the BITZONECOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render BITZONECOIN addresses in monospace font
...
// Parse "bitzonecoin:" URI into recipient object, return true on successful parsing
