...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BITZONECOIN Core"),
     ...
     * override -datadir in the bitzonecoin.conf file in the default data directory
     * (to be consistent with bitzonecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
