                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BITZONECOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BITZONECOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitzonecoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zADAI"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BITZONECOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about BITZONECOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BITZONECOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BITZONECOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BITZONECOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a BITZONECOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BITZONECOIN Core help message to get a list with possible BITZONECOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BITZONECOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BITZONECOIN network", "", count));
}
...
{
    QString strTitle = tr("BITZONECOIN Core"); // default title
