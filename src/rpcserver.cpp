...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BITZONECOIN server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BITZONECOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitZoneCoin features */
        {"bitzonecoin", "masternode", &masternode, true, true, false},
        {"bitzonecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bitzonecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitzonecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitzonecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitzonecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bitzonecoin", "startmasternode", &startmasternode, true, true, false},
        {"bitzonecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitzonecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitzonecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitzonecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitzonecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitzonecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitzonecoin", "mnbudget", &mnbudget, true, true, false},
        {"bitzonecoin", "preparebudget", &preparebudget, true, true, false},
        {"bitzonecoin", "submitbudget", &submitbudget, true, true, false},
        {"bitzonecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitzonecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitzonecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitzonecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitzonecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitzonecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitzonecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitzonecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bitzonecoin", "mnsync", &mnsync, true, true, false},
        {"bitzonecoin", "spork", &spork, true, true, false},
        {"bitzonecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitzonecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitzonecoind, or the -server option to bitzonecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitzonecoin-cli " + methodname + " " + args + "\n";
}
