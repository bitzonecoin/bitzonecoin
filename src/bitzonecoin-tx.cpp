...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitZoneCoin Core bitzonecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitzonecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitzonecoin transaction") + "\n" +
                               "  bitzonecoin-tx [options] -create [commands]   " + _("Create hex-encoded bitzonecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitzonecoin transaction
