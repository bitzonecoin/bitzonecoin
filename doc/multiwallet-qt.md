...
In order to support loading of multiple wallets in bitzonecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitzonecoin.cpp.
...
Changes to bitzonecoin.cpp
----------------------
bitzonecoin.cpp is the entry point into bitzonecoin-qt, and as such, will require some minor modifications to provide hooks for
